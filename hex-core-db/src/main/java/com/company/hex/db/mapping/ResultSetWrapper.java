...
/**
 * Обёртка над ResultSet для делегирования вызовов.
 *
 * <p>Используется для переопределения поведения ResultSet
 * в специфических сценариях маппинга.</p>
 *
...
class ResultSetWrapper implements ResultSet {
    ...
    ResultSetWrapper(ResultSet delegate) {
        this.delegate = Objects.requireNonNull(delegate, "Delegate ResultSet cannot be null");
    }
