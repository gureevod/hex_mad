# Epic List
- Epic 1: Core Framework Foundation and Parallel-Ready Scaffolding — Establish `hex-core` modules, configuration, logging, reporting, and JUnit 5 parallel scaffolds; deliver first working API and UI sample tests with Allure.
